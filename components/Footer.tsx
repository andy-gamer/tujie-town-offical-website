      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 text-left w-full max-w-5xl mx-auto mb-10 md:mb-16 border-t border-white/5 pt-8 md:pt-12 px-4">
           ...
           <div className="space-y-4">
             ...
             <p className="text-mist-grey/60 text-xs md:text-sm font-sans tracking-wide"><span className="text-moon-silver/80 font-bold mr-2">{t.footer.gameDesign}｜</span> DB、芝芝、安迪</p>
             ...
             <p className="text-mist-grey/60 text-xs md:text-sm font-sans tracking-wide"><span className="text-moon-silver/80 font-bold mr-2">{t.footer.supporter}｜</span> 腦鼠、御井、布丁、星光</p>
           </div>
           <div className="space-y-4">
        ...
        <div className="flex flex-col items-center gap-6 border-t border-white/5 pt-8 w-full max-w-5xl">
          <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-[10px] text-mist-grey/40 tracking-wider font-sans uppercase px-4">
            ...
            <span>/</span>
            <button className="hover:text-mist-grey transition-colors cursor-not-allowed opacity-50">{t.footer.terms}</button>
            <span>/</span>
