      ...
      <section id="hero" className="relative w-full h-screen min-h-[600px] overflow-hidden bg-midnight-fog select-none flex flex-col md:block">
        ...
        */}
        <div className="relative w-full flex-1 md:absolute md:inset-0 md:h-full overflow-hidden shrink-0 h-[60vh] md:h-auto">
           ...
           <div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-midnight-fog to-transparent md:hidden"></div>
        ...
        */}
        <div className="relative md:absolute md:bottom-32 md:left-0 w-full px-0 md:px-24 pointer-events-auto z-30 flex justify-center md:justify-start bg-midnight-fog md:bg-transparent shadow-2xl md:shadow-none border-t border-lantern-red/30 md:border-t-0">
           <div className="p-8 md:p-12 md:border-l-4 md:border-lantern-red/60 bg-midnight-fog md:bg-[#1D1F21]/60 md:backdrop-blur-sm max-w-full md:max-w-2xl w-full relative overflow-hidden group pb-12 md:pb-12">
              {/* Subtle sheen effect */}
