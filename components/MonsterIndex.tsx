    ...
    <section id="collection" className="py-12 md:py-24 bg-[#151719] relative overflow-hidden border-t border-lily-shadow flex justify-center">
      ...
      <div className="w-full max-w-[95%] md:max-w-[90%] relative z-10">
        <div className="text-center mb-10 md:mb-16">
           ...
           <p className="text-white/60 font-serif text-sm md:text-lg max-w-3xl mx-auto leading-loose opacity-70 px-4 whitespace-pre-wrap">
             {t.monster.subtitle}
           </p>
        </div>
        ...
        <div className={`relative bg-[#5c554b] p-1 md:p-2 rounded-sm shadow-[0_50px_100px_rgba(0,0,0,0.9)] mx-auto w-full max-w-[1200px] transform md:rotate-[0.5deg] transition-all duration-700`}>
           {/* Tab */}
           <div className="absolute -top-8 md:-top-10 left-4 md:left-10 bg-[#5c554b] px-6 md:px-12 py-2 md:py-3 rounded-t-md border-t border-l border-r border-[#4a443b] shadow-sm z-0">
              <span className="text-red-900/60 font-mono font-bold tracking-widest text-xs md:text-lg">{t.monster.caseId}</span>
           </div>
                 ...
                 <div className="relative z-40 flex flex-col items-center justify-center text-center w-full">
                    ...
                    <div className="relative w-full max-w-lg bg-[#e3dac9] p-8 md:p-12 shadow-[0_10px_40px_rgba(0,0,0,0.3)] border border-[#b0a48f] transform rotate-1">
                         ...
                         <div className="relative z-10 flex flex-col items-center">
                            ...
                            <p className="text-[#5c554b] font-serif font-bold text-xs md:text-base mb-8 tracking-widest mt-4">
                               {t.monster.lockedOverlay.desc}
                            </p>

                            {/* Item Status Icons */}
                            <div className="flex justify-center gap-4 mb-8 w-full bg-[#4a443b]/5 p-4 border border-[#4a443b]/10">
                              {ITEMS.map((item, idx) => (
                            ...
                            <div className="w-full">
                               <div className="flex justify-between text-[#4a443b] font-mono text-[10px] font-bold mb-1 tracking-widest uppercase">
                ...
                <div className={`transition-all duration-1000 w-full h-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 relative z-10 animate-fade-in`}>
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6 lg:gap-8 order-2 lg:order-1">
                        ...
                        <div className="bg-white p-2 pb-10 shadow-md transform -rotate-1 border border-gray-300 relative w-full max-w-sm mx-auto lg:max-w-full">
                            <img src={ASSETS.monsterSketch} className="w-full h-48 md:h-64 object-contain mix-blend-multiply grayscale contrast-125" alt="Subject" />
                        ...
                        <div className="bg-[#b0a48f]/40 p-5 border border-[#9c917e]">
                            <h4 className="text-[#4a443b] font-mono font-bold tracking-widest mb-4 border-b border-[#9c917e] pb-2 text-sm">
                              {t.monster.file.items.title}
                            </h4>
                            <ul className="text-[#2b2520] text-sm md:text-base space-y-3 list-disc pl-5 font-serif leading-relaxed">
                    ...
                    <div className="lg:col-span-8 font-serif text-[#2b2520] relative flex flex-col gap-6 md:gap-8 order-1 lg:order-2">
